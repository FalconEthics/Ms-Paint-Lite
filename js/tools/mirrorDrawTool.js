function mirrorDrawTool() {
  ...
  this.populateOptions = function () {
    select(".options").html(
      `<button id='directionButton' class='w-fit text-lg font-medium bg-white text-black p-1 px-4 rounded-lg drop-shadow-lg hover:scale-90'>Make Horizontal</button>
